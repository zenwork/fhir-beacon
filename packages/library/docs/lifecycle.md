...
All complex types, resources, and domain resources implement [BaseElement](internal/BaseElement.ts) .
...
The FHIR [Primitive](components/primitive/primitive.ts) is the base key-value and key-input component in the
