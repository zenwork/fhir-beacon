export const CodeSystemAddressUse = {
  ...
  identifier: [{ system: 'urn:ietf:rfc:3986', value: 'urn:oid:2.16.840.1.113883.4.642.1.68' }],
  version: '5.0.0',
  name: 'AddressUse',
  title: 'AddressUse',
  status: 'active',
