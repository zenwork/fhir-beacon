...
import { Decorated, ValidationsImpl, decorate } from "../../../internal";
...
export const WithError: Story = {
	...
	render: (args: ShellArgs) => {
		const [validations, concept, _choices] = prepare(
			args.data as CodeableConceptData,
...
function prepare(
	data: CodeableConceptData,
	bindingId: CodeIds,
): [
	ValidationsImpl<CodeableConceptData>,
	Decorated<CodeableConceptData>,
	Choices,
] {
	const concept: Decorated<CodeableConceptData> = decorate(
		"_root",
		data,
		undefined,
	);
