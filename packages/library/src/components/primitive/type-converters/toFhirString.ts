...
export const toFhirString: toPrimitive<unknown, FhirString> = (
	unknown: unknown,
): FhirString => {
	...
	// biome-ignore lint/suspicious/noControlCharactersInRegex: FHIR strings disallow these control characters
	const regex = /[\u0000-\u0008\u000B-\u000C\u000E-\u001F\u007F-\u009F]/g;
