...
describe("toInstant", () => {
	...
	it("should convert an instant string with a positive offset to Instant", () => {
		...
		expect(toInstant(offsetPositiveInstant)).toBe(
			offsetPositiveInstant as Instant,
		);
	});
	...
	it("should convert an instant string with a negative offset to Instant", () => {
		...
		expect(toInstant(offsetNegativeInstant)).toBe(
			offsetNegativeInstant as Instant,
		);
	});
