 ...
 *   (\S+\s)?    - An optional group that matches one or more non-whitespace characters followed by a whitespace
 * character. This is used to match an optional leading indentation.
