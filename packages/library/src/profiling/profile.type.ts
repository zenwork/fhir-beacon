...
export interface Define {
	oneOf: <T extends Decorateable>(
		key: string,
		typeName: Name,
		narrowingTypes?: NarrowableDef[],
	) => PropertyBuilder<T>;
	optionOf: <T extends Decorateable>(
		key: string,
		typeName: Name,
		narrowingTypes?: NarrowableDef[],
	) => PropertyBuilder<T>;
	choiceOf: <T extends Decorateable>(
		choice: string,
		key: string,
		typeName: Name,
		narrowingTypes?: NarrowableDef[],
	) => PropertyBuilder<T>;
	minOneOf: <T extends Decorateable>(
		key: string,
		typeName: Name,
		narrowingTypes?: NarrowableDef[],
	) => PropertyBuilder<T>;
	listOf: <T extends Decorateable>(
		key: string,
		typeName: Name,
		narrowingTypes?: NarrowableDef[],
	) => PropertyBuilder<T>;
	optionalListOf: <T extends Decorateable>(
		key: string,
		typeName: Name,
		narrowingTypes?: NarrowableDef[],
	) => PropertyBuilder<T>;
	backboneOf: <T extends Decorateable>(
		key: string,
		props: StructureDefinition<T>,
	) => PropertyBuilder<T>;
	backboneListOf: <T extends Decorateable>(
		key: string,
		props: StructureDefinition<T>,
	) => PropertyBuilder<T>;
}
...
export interface Slice {
	oneFor: <T extends Decorateable>(
		key: string[],
		constraints: DefConstraintAssertion<T>[],
		fixedValue?: unknown[],
		choice?: string,
	) => Builder<T>;
	constraint: <T extends Decorateable>(
		key: string[],
		constraints: DefConstraintAssertion<T>[],
		fixedValue?: unknown[],
		choice?: string,
