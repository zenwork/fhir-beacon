...
export class ResourceDef {
	...
	static AdministrableProductDefinition = new ResourceDef(
	...
	static BiologicallyDerivedProduct = new ResourceDef(
		"BiologicallyDerivedProduct",
	);
	static BiologicallyDerivedProductDispense = new ResourceDef(
	...
	static CoverageEligibilityRequest = new ResourceDef(
		"CoverageEligibilityRequest",
	);
	static CoverageEligibilityResponse = new ResourceDef(
	...
	static ImmunizationRecommendation = new ResourceDef(
	...
	static ManufacturedItemDefinition = new ResourceDef(
	...
	static MedicinalProductDefinition = new ResourceDef(
	...
	static PackagedProductDefinition = new ResourceDef(
	...
	static SubstanceReferenceInformation = new ResourceDef(
	 ...
	 */
	constructor(
		value: ResourceName | `${ResourceName}${string}`,
		profile?: string,
	) {
		this.value = value;
