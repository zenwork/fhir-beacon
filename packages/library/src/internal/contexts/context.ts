...
export const containedResourcesContext = createContext<ResourceData[]>(
	containedResourcesKey,
);
export const displayConfigContext =
	createContext<DisplayConfig>(displayConfigKey);
