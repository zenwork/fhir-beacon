...
import {
	containedResourcesContext,
	dataContext,
	displayConfigContext,
} from "./context";

//TODO: maybe shoudl be split into two separate controllers
export class ContextProviderController<
	T extends FhirElementData,
	B extends BaseElement<T>,
> implements ReactiveController
{
	...
	hostUpdated() {
		...
		this.displayCtx.setValue({
			...this.displayCtx.value,
			source,
			mode,
			showerror,
			verbose,
