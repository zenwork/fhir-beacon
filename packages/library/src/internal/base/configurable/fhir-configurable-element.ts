...
export abstract class ConfigurableElement extends LitElement {
	...
	public get mode(): DisplayMode {
		return this._mode ?? this.displayConfig?.mode ?? DisplayMode.display;
	}
	public set mode(value: DisplayMode) {
		this._mode = toDisplayMode(value);
	}
	...
	public get showerror(): boolean {
		return this._showerror ?? this.displayConfig?.showerror ?? false;
	}
	...
	public get verbose(): boolean {
		return this._verbose ?? this.displayConfig?.verbose ?? false;
	}
	 ...
	 */
	@property({ type: Boolean })
	public get summaryonly(): boolean {
		return this._summaryonly ?? this.displayConfig?.summaryonly ?? false;
	}
	public set summaryonly(value: boolean) {
	...
	public get open(): boolean {
		return this._open ?? this.displayConfig?.open ?? false;
	}
