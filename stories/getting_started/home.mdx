...
* Out-of-the-box support for narratives and summaries (TODO)
* Display FHIR validation errors
* Display data in user-friendly format
* Diplay detailed FHIR models
* \[TODO] Extend components to customize what and how it is rendered
* \[TODO] Theme your UIs with Shoelace theme support
* \[TODO] Create your own html elements to support you own FHIR extensions or to support custom layouts
